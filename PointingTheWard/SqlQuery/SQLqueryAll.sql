...
DESC TRIGGER GROUP_DELETE_TRIGGER
...
FROM EVENT_TB ET, MEMBER_TB MT, E_PARTICIPANT_TB PT
WHERE 
...
VALUES(EVENT_SEQUENCE.NEXTVAL,'성봉일정1','시작날','끝날','시작시간','종료시간','내용','장소');
INSERT INTO EVENT_TB(E_CODE,TITLE,S_DATE,E_DATE,S_TIME,E_TIME,CONTENT,PLACE)
VALUES(EVENT_SEQUENCE.NEXTVAL,'성봉일정2','시작날','끝날','시작시간','종료시간','내용','장소');
INSERT INTO EVENT_TB(E_CODE,TITLE,S_DATE,E_DATE,S_TIME,E_TIME,CONTENT,PLACE)
VALUES(EVENT_SEQUENCE.NEXTVAL,'대진일정1','시작날','끝날','시작시간','종료시간','내용','장소');
INSERT INTO EVENT_TB(E_CODE,TITLE,S_DATE,E_DATE,S_TIME,E_TIME,CONTENT,PLACE)
VALUES(EVENT_SEQUENCE.NEXTVAL,'대진일정2','시작날','끝날','시작시간','종료시간','내용','장소');
INSERT INTO EVENT_TB(E_CODE,TITLE,S_DATE,E_DATE,S_TIME,E_TIME,CONTENT,PLACE)
VALUES(EVENT_SEQUENCE.NEXTVAL,'장해일정1','시작날','끝날','시작시간','종료시간','내용','장소');
